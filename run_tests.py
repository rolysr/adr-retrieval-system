from testing.boolean_model_test import *
from testing.preprocessing_test import *
...
of the main features implemented on the project. You can uncomment a line in order
to run an specific test or you can add your own test file on ./testing folder
"""

# run_preprocessing_test()
# run_query_expansion_test()
# run_boolean_model_test()
# run_vector_space_model_test()
# run_vector_feedback_test()
# run_crawler_test()
# run_adr_system_test()
# run_metrics_tests()